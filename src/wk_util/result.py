...
class ResultPack:
    ...
    def add_metric(self, key: str, data: pd.DataFrame | OrderedDict, *, plot_func=None):
        """
        Parameters
        --------
        key : str
...
class ResultSetPack:
    ...
    def __setitem__(self, key, value: ResultPack):
