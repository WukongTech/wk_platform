...
class TestTuShareLiveFeed(TestCase):
    @mock.patch('wk_pyalgotrade.tushare.barfeed.is_holiday')
    @mock.patch('wk_pyalgotrade.tushare.barfeed.ts')
    ...
    @mock.patch('wk_pyalgotrade.tushare.barfeed.is_holiday')
    @mock.patch('wk_pyalgotrade.tushare.barfeed.get_trading_days')
    @mock.patch('wk_pyalgotrade.tushare.barfeed.ts')
